...
import { LayoutDashboard, Users, CreditCard, ArrowLeftRight, FileText, Bot, Settings, LogOut, ArrowLeft, Megaphone, Star } from 'lucide-react';
  ...
  return (
    <aside style={sidebarStyle}>
      <div style={{ padding: '20px 20px 16px', display: 'flex', alignItems: 'center', gap: '12px' }}>
        <Link to="/admin/dashboard"><img src={logo} alt="PATHEW" style={{ height: '32px' }} /></Link>
